...
import org.ovgu.de.classifier.utility.NormalizeCase;
import org.ovgu.de.classifier.utility.NormalizeCase.NormType;
...
public class SAX extends SimpleBatchFilter {
    ...
    public static void main(String[] args) {
        ...
        try {
            Instances test = ClassifierTools.loadData("E:/user-study/HE_3.arff");
            
            NormalizeCase nc = new NormalizeCase();
            nc.setNormType(NormType.STD_NORMAL);
         //   test = nc.process(test);
            
            SAX sax = new SAX();
            sax.setNumIntervals(7);
